...
public class RegisterPanel extends JPanel{
	...
	public RegisterPanel() {
		...
		usernameLabel = new JLabel("Vendos Username:");
		...
		passwordLabel = new JLabel("Vendos Password:");
		...
		// welcome label
		welcomeLabel = new JLabel("Mirësevini");
		welcomeLabel.setBounds(140, 40, 400, 100);
		...
		// register button
		registerButton = new JButton("Regjistrohu");
