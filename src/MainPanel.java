...
public class MainPanel extends JPanel{
	...
	public MainPanel() {
		...
		// labirinti tekst
		labirintiTekst = new JLabel("Labirinti");
		labirintiTekst.setBounds(130, 0, 400, 90);
		labirintiTekst.setForeground(Color.ORANGE);
		if(joystix != null) {
			labirintiTekst.setFont(joystix.deriveFont(50f));
		} else {
			labirintiTekst.setFont(new Font("Arial", Font.BOLD, 20));
		}
